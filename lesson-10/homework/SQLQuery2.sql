...
SELECT e.Name, ISNULL(d.DepartmentName, 'No dep') FROM Employees as e
...
SELECT FirstName, LastName, COUNT(o.OrderID) as TotalOrders FROM Customers as c
JOIN Orders as o ON c.CustomerID = o.CustomerID
...
SELECT e1.Name, e2.Name, e2.ManagerID FROM Employees as e1
...
--e1.Name, e1.Salary FROM
SELECT e1.Name, e1.Salary FROM Employees as e1
JOIN 
(SELECT d.DepartmentID,d.DepartmentName, AVG(e.Salary) as avg_sala FROM Employees as e
JOIN Departments as d ON e.DepartmentID =d.DepartmentID
GROUP BY d.DepartmentID,d.DepartmentName) as d2 ON e1.DepartmentID = d2.DepartmentID
WHERE d2.avg_sala < e1.Salary
...
SELECT e1.Name, e2.Name, e2.ManagerID,e1.Salary FROM Employees as e1
JOIN Employees as e2 ON e1.EmployeeID = e2.ManagerID
