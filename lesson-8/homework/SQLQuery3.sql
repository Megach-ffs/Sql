...
SELECT Category, AVG(Price) FROM Products GROUP BY Category HAVING Category = 'Electronics'
...
SELECT min(Quantity) as min_, max(Quantity) as max_ FROM Orders 
...
/*This task wasnt covered during lecture, so it must be skipped*/
