...
SELECT *, IIF(StockQuantity>100, 'Yes', 'No') AS Enough FROM Products_Discounted
...
SELECT *,
	IIF(Price>1000, 'Expensive', 'Affordable') AS Can_Buy
FROM Products
...
--SELECT * FROM Employees WHERE DepartmentName = 'HR' OR EmployeeID = 5
